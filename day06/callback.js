...
//   let paymentStatment = status ? "결제 완료" : "결제 취소";
//   result = `${productName}은(는) ${paymentStatment}`;
//   callback(result)
// }
...
// const ismultiplyBy5 = (num, callback) => {
...
const getMax = (num1, num2, callback) => {
   // 사용자가 입력한 값이 number인지 아닌지 타입 비교
